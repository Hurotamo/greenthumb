...
// New function to log action with timestamp and partially censored geolocation
...
// Function to censor parts of the geolocation string
fn censor_geolocation(geolocation: &str) -> String {
    // Example: Replace the last 4 characters with ****
...
// Parse instruction data with better error handling
